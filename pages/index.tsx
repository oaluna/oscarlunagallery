...
const Home: NextPage = ({ images }: { images: ImageProps[] }) => {
	...
	return (
		<>
			<Head>
				<title>Oscar Luna's Art Gallery</title>
				<meta
					property="og:image"
					content="https://res.cloudinary.com/dgdnpkfun/image/upload/v1622161469/oscarLogo.png"
				/>
				<meta
					name="twitter:image"
					content="https://res.cloudinary.com/dgdnpkfun/image/upload/v1622161469/oscarLogo.png"
			...
			<main className="mx-auto max-w-[1960px] p-4">
				...
				<div className="gap-4 columns-1 sm:columns-2 xl:columns-3 2xl:columns-4">
					...
					{images.map(({ id, public_id, format, blurDataUrl }) => (
						...
						>
							<Image
								alt="Illustration by Oscar Luna"
			...
			<footer className="p-6 text-center text-white/80 sm:p-12">
				&copy; 2023 by <a href="https://oscarluna.dev">Oscar Armando Luna</a>
			</footer>
		</>
	)
}
